...
function addListener(a, b, c) {
    let element = (typeof a == "string") ? document.querySelector(a) : a;
    console.debug(element)
    if (!(element === document || element.hasAttribute(b) || element.hasAttribute("example"))) {
        element.addEventListener(b, c);
        console.debug("added event listener to " + element)
        element.setAttribute(b, "true");
    }
}
